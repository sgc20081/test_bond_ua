...
# API urls
urlpatterns += [
    path('api/movies-list', apis.MovieListAPI.as_view()),
    path('api/directors-api', apis.DirectorListAPI.as_view()),
    path('api/actors-api', apis.ActorListAPI.as_view()),
    path('api/create-movie-api', apis.MovieCreateAPI.as_view()),
    path('api/update-movie-api', apis.MovieUpdateAPI.as_view()),
